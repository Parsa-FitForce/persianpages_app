...
const CITIES: CityConfig[] = [
  ...
  { nameEn: 'Leeds', name: 'لیدز', country: 'انگلستان', countryCode: 'gb', priority: 3 },
  { nameEn: 'Glasgow', name: 'گلاسگو', country: 'انگلستان', countryCode: 'gb', priority: 3 },
  { nameEn: 'Bristol', name: 'بریستول', country: 'انگلستان', countryCode: 'gb', priority: 3 },
  { nameEn: 'Liverpool', name: 'لیورپول', country: 'انگلستان', countryCode: 'gb', priority: 3 },
  { nameEn: 'Newcastle', name: 'نیوکاسل', country: 'انگلستان', countryCode: 'gb', priority: 3 },
  { nameEn: 'Uppsala', name: 'اوپسالا', country: 'سوئد', countryCode: 'se', priority: 3 },
  { nameEn: 'Linkoping', name: 'لینشوپینگ', country: 'سوئد', countryCode: 'se', priority: 3 },
  { nameEn: 'Adelaide', name: 'آدلاید', country: 'استرالیا', countryCode: 'au', priority: 3 },
  { nameEn: 'Canberra', name: 'کانبرا', country: 'استرالیا', countryCode: 'au', priority: 3 },
  { nameEn: 'Marseille', name: 'مارسی', country: 'فرانسه', countryCode: 'fr', priority: 3 },
  { nameEn: 'Toulouse', name: 'تولوز', country: 'فرانسه', countryCode: 'fr', priority: 3 },
  { nameEn: 'Nice', name: 'نیس', country: 'فرانسه', countryCode: 'fr', priority: 3 },
  { nameEn: 'Utrecht', name: 'اوترخت', country: 'هلند', countryCode: 'nl', priority: 3 },
  { nameEn: 'Eindhoven', name: 'آیندهوون', country: 'هلند', countryCode: 'nl', priority: 3 },
  { nameEn: 'Graz', name: 'گراتس', country: 'اتریش', countryCode: 'at', priority: 3 },
  { nameEn: 'Linz', name: 'لینتس', country: 'اتریش', countryCode: 'at', priority: 3 },
  { nameEn: 'Rome', name: 'رم', country: 'ایتالیا', countryCode: 'it', priority: 3 },
  { nameEn: 'Turin', name: 'تورین', country: 'ایتالیا', countryCode: 'it', priority: 3 },
  { nameEn: 'Bologna', name: 'بولونیا', country: 'ایتالیا', countryCode: 'it', priority: 3 },
  { nameEn: 'Florence', name: 'فلورانس', country: 'ایتالیا', countryCode: 'it', priority: 3 },
  { nameEn: 'Naples', name: 'ناپل', country: 'ایتالیا', countryCode: 'it', priority: 3 },
  { nameEn: 'Genoa', name: 'جنوا', country: 'ایتالیا', countryCode: 'it', priority: 3 },
  { nameEn: 'Palermo', name: 'پالرمو', country: 'ایتالیا', countryCode: 'it', priority: 3 },
  { nameEn: 'Valencia', name: 'والنسیا', country: 'اسپانیا', countryCode: 'es', priority: 3 },
  { nameEn: 'Seville', name: 'سویا', country: 'اسپانیا', countryCode: 'es', priority: 3 },
  { nameEn: 'Malaga', name: 'مالاگا', country: 'اسپانیا', countryCode: 'es', priority: 3 },
  { nameEn: 'Bilbao', name: 'بیلبائو', country: 'اسپانیا', countryCode: 'es', priority: 3 },
  { nameEn: 'Alicante', name: 'آلیکانته', country: 'اسپانیا', countryCode: 'es', priority: 3 },
  { nameEn: 'Bergen', name: 'برگن', country: 'نروژ', countryCode: 'no', priority: 3 },
  { nameEn: 'Trondheim', name: 'تروندهایم', country: 'نروژ', countryCode: 'no', priority: 3 },
  { nameEn: 'Aarhus', name: 'آرهوس', country: 'دانمارک', countryCode: 'dk', priority: 3 },
  { nameEn: 'Odense', name: 'اودنسه', country: 'دانمارک', countryCode: 'dk', priority: 3 },
  { nameEn: 'Antwerp', name: 'آنتورپ', country: 'بلژیک', countryCode: 'be', priority: 3 },
  { nameEn: 'Ghent', name: 'گنت', country: 'بلژیک', countryCode: 'be', priority: 3 },
  { nameEn: 'Bern', name: 'برن', country: 'سوئیس', countryCode: 'ch', priority: 3 },
  { nameEn: 'Basel', name: 'بازل', country: 'سوئیس', countryCode: 'ch', priority: 3 },
  { nameEn: 'Wellington', name: 'ولینگتون', country: 'نیوزیلند', countryCode: 'nz', priority: 3 },
  { nameEn: 'Christchurch', name: 'کرایستچرچ', country: 'نیوزیلند', countryCode: 'nz', priority: 3 },
  { nameEn: 'Osaka', name: 'اوساکا', country: 'ژاپن', countryCode: 'jp', priority: 3 },
  { nameEn: 'Yokohama', name: 'یوکوهاما', country: 'ژاپن', countryCode: 'jp', priority: 3 },
  { nameEn: 'Penang', name: 'پنانگ', country: 'مالزی', countryCode: 'my', priority: 3 },
];
